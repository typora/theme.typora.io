...
| ------ | ------ | -------- | ------------------------------------------------ | --------------------------------------------------------- | -------- | --------- | --------- | --------------- | ------------------------ |
| Theme  | Inside | Theme    | https://github.com/FishionYu/typora-inside-theme | https://github.com/FishionYu/typora-inside-theme/releases | false    | FishionYu | Inside    | ../../          | ../../media/theme/Inside |
